...
import asyncio
import json
from TestCubeDemo.TestCubeComponents.adc import AdcMessage
from TestCubeDemo.TestCubeComponents.pwm import PwmMessage
from TestCubeDemo.TestCubeComponents.relay import RelayMessage
from TestCubeDemo.TestCubeComponents.di import DiMessage
from TestCubeDemo.TestCubeComponents.actuators import ActCurMessage
from TestCubeDemo.TestCubeComponents.frequency import FrequencyMessage
from TestCubeDemo.TestCubeComponents.usb import UsbMessage
from TestCubeDemo.TestCubeComponents.can import CanDatabaseMessage
...
class TestCubeDemo(
    ...
    def __init__(self):
        ...
        with open(self.__class__.__name__ + "/schema.json") as f:
